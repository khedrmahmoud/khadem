...
class FileUploadController {
  ...
  Future<Map<String, dynamic>> handleMultipleFileUpload(
    ...
    try {
      ...
      final validator = InputValidator(requestData, rules);
  ...
  Future<Map<String, dynamic>> handleProfileImageUpload(
    Map<String, dynamic> requestData,
  ) async {
  ...
  Future<Map<String, dynamic>> handleDocumentBatch(
    Map<String, dynamic> requestData,
  ) async {
    final rules = {
      // User information
      ...
      'documents.*.file':
          'required|file|max:10240|mimes:pdf,doc,docx', // 10MB max
