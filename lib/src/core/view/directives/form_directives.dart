...
class MethodDirective implements ViewDirective {
  @override
  Future<String> apply(String content, Map<String, dynamic> context) async {
    return content.replaceAllMapped(RegExp(r"@method\('([A-Za-z]+)'\)"), (
      match,
    ) {
...
class RouteDirective implements ViewDirective {
  @override
  Future<String> apply(String content, Map<String, dynamic> context) async {
    return content.replaceAllMapped(RegExp(r"@route\('([^']+)'\)"), (match) {
...
class UrlDirective implements ViewDirective {
  @override
  Future<String> apply(String content, Map<String, dynamic> context) async {
    return content.replaceAllMapped(RegExp(r"@url\('([^']+)'\)"), (match) {
...
class ActionDirective implements ViewDirective {
  @override
  Future<String> apply(String content, Map<String, dynamic> context) async {
    return content.replaceAllMapped(RegExp(r"@action\('([^']+)'\)"), (match) {
