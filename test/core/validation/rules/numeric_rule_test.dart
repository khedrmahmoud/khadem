...
void main() {
  ...
  group('NumericRule', () {
    ...
    test('should return true when value is a decimal number', () async {
      final result = await rule.passes(
        ValidationContext(attribute: 'field', value: 42.5, data: {}),
      );
      expect(result, isTrue);
    });

    test(
      'should return true when value is a string containing valid integer',
      () async {
        final result = await rule.passes(
          ValidationContext(attribute: 'field', value: '42', data: {}),
        );
    ...
    test(
      'should return true when value is a string containing valid decimal',
      () async {
        final result = await rule.passes(
          ValidationContext(attribute: 'field', value: '42.5', data: {}),
        );
    ...
    test('should return false when value is non-numeric string', () async {
      final result = await rule.passes(
        ValidationContext(attribute: 'field', value: 'not-a-number', data: {}),
      );
